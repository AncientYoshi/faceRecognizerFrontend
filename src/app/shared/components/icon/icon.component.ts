  ...
  template: `
    ...
    >
      @switch (name) {
        ...
        @case ('teacher') {
          <path d="m2 7 10-5 10 5-10 5zM6 10v5c2 2 4 3 6 3s4-1 6-3v-5M22 7v6" />
        }
        @case ('book') {
          <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V3H6.5A2.5 2.5 0 0 0 4 5.5zM4 5.5v14" />
        }
        @case ('building') {
          <path d="M3 21h18M6 21V6l6-3 6 3v15M9 9h1M14 9h1M9 13h1M14 13h1M9 17h1M14 17h1" />
        }
        @case ('calendar') {
        ...
        @case ('scan') {
          <path
            d="M3 7V5a2 2 0 0 1 2-2h2M17 3h2a2 2 0 0 1 2 2v2M21 17v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2M8 11a4 4 0 0 1 8 0M9 17c.8-2 1.8-3 3-3s2.2 1 3 3M8 11h8"
          />
        }
        @case ('camera') {
          <path
        ...
        @case ('refresh') {
          <path d="M20 7h-5V2M20 7a9 9 0 1 0 1 8" />
        }
        @case ('info') {
          <circle cx="12" cy="12" r="9" />
