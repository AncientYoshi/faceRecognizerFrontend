...
export const PREVIEW_SESSIONS: AttendanceSession[] = [
  {
    ...
    courseId: '1',
    courseCode: 'ME 51021',
    courseName: 'Robotic Analysis',
    teacherId: '1',
    teacherUserId: '1',
    teacherName: 'Daw Aye',
    sessionDate: '2026-08-04',
    startTime: '2026-08-04T10:00:00+06:30',
    endTime: '2026-08-04T12:00:00+06:30',
    rollCallCount: 1,
    status: 'ACTIVE',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    teacherName: 'Mg Mg',
    sessionDate: '2026-08-04',
    startTime: '2026-08-04T13:00:00+06:30',
    endTime: '2026-08-04T15:00:00+06:30',
    rollCallCount: 1,
    status: 'SCHEDULED',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    sessionDate: '2026-08-04',
    startTime: '2026-08-04T15:30:00+06:30',
    endTime: '2026-08-04T17:30:00+06:30',
    rollCallCount: 1,
    status: 'SCHEDULED',
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    sessionDate: '2026-08-04',
    startTime: '2026-08-04T09:00:00+06:30',
    endTime: '2026-08-04T11:00:00+06:30',
    rollCallCount: 1,
    status: 'CLOSED',
    createdAt: '',
    updatedAt: '',
...
export class AttendanceService {
      ...
      return of(
        this.page([
          ...
          },
          {
            ...
            courseName: 'Structural Design',
            sessionId: '2',
            attendanceTime: new Date(Date.now() - 86400000).toISOString(),
            status: 'PRESENT',
  ...
  getAttendance(id: string): Observable<AttendanceRecord> {
    if (this.auth.isPreview())
      return this.listMyAttendance().pipe(
        switchMap((x) => of(x.content.find((r) => r.id === id)!)),
      );
  ...
  verify(sessionId: string, image: Blob): Observable<AttendanceVerification> {
    ...
    return this.http.post<AttendanceVerification>(`${environment.apiUrl}/attendance/verify`, body, {
      params: { sessionId },
    });
  }
