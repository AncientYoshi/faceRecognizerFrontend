...
export const PREVIEW_DASHBOARD: AdminDashboardView = {
  ...
  recentSessions: [
    ...
    },
    {
      ...
      sessionDate: '2026-08-04',
      startTime: '2026-08-04T16:00:00Z',
...
export class DashboardService {
  ...
  getAdminDashboard(): Observable<AdminDashboardView> {
    ...
    return forkJoin({
      ...
      users: this.http.get<PageResponse<UserSummary>>(`${environment.apiUrl}/users`, {
        params: { page: 0, size: 4 },
      }),
      courses: this.http.get<PageResponse<unknown>>(`${environment.apiUrl}/courses`, {
  ...
  getTeacherDashboard(): Observable<TeacherDashboard> {
    if (this.auth.isPreview())
      return of({
        ...
        attendanceRecords: 182,
        expectedAttendance: 195,
        attendanceRate: 93.3,
      });
  ...
  getStudentDashboard(date: string): Observable<StudentDashboard> {
    ...
    return this.http.get<StudentDashboard>(`${environment.apiUrl}/dashboard/student`, {
      params: { date },
    });
  }
}
